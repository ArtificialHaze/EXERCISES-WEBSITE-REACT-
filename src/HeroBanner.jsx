...
const HeroBanner = () => {
  return (
    <Box sx={{
        ...
        <Typography mb={4} fontSize={'22px'} lineHeight={'35px'}>Check out the most effective exercises</Typography>
        <Button  sx={{backgroundColor:'#ff2625',padding:'10px'}} variant='contained' color='error' href='#exercises'>Explore</Button>
